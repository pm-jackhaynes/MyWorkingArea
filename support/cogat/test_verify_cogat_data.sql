...
call md_hcps.etl_pm_bbcard_measure_select();
...
Select * from md_hcps_ods.pmi_ods_cogat;
        


/*  ****************************************************************************************************************************************************************

      Restore pmi_ods_cogat using your backup pmi_ods_cogat_jack table
      
 *  ************************************************************************************************************************************************************** */

truncate md_hcps_ods.pmi_ods_cogat;
insert into md_hcps_ods.pmi_ods_cogat (
row_num,
student_id,
student_name,
grade,
...
lexile_min,
Lexile_Max
From  md_hcps_ods.pmi_ods_cogat_jack;

/*  ****************************************************************************************************************************************************************

      Truncate pmi_ods_cogat and load your test data
