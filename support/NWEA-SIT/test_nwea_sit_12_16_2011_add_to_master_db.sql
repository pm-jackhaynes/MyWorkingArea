...
--          `state_id` int(10) NOT NULL,
       ...
       -- supporting the clients baseball card reporting.
        ...
        values
                ...
                ,('nwea-rit', 'langSurveyWGoals', 'stdntWriteExpositoryGoalRITScore4Fall', 'Students Write: Expository: Goal RIT Score 4 - Fall', 11, NULL,'n', 1, 0, 1234, now() )
                ...
                ,('nwea-rit', 'langSurveyWGoals', 'growtMeasureYNFall', 'Growth Measure - Fall', 21, 'pmiRedGreen', 'a', 1, 0, 1234, now() )
                ...
                ,('nwea-rit', 'mathSurveyWGoals', 'growtMeasureYNFall', 'Growth Measure - Fall', 14, 'pmiRedGreen', 'a', 1, 0, 1234, now() )
                ...
                ,('nwea-rit', 'nweaAlgebra', 'growtMeasureYNFall', 'Growth Measure - Fall', 15, 'pmiRedGreen', 'a', 1, 0, 1234, now() )
                ...
                ,('nwea-rit', 'primaryMath', 'growtMeasureYNFall', 'Growth Measure - Fall', 19, 'pmiRedGreen', 'a', 1, 0, 1234, now() )
                ...
                ,('nwea-rit', 'primaryReading', 'growtMeasureYNFall', 'Growth Measure - Fall', 19, 'pmiRedGreen', 'a', 1, 0, 1234, now() )
                ...
                ,('nwea-rit', 'readingSurveyWGoals', 'growtMeasureYNFall', 'Growth Measure - Fall', 15, 'pmiRedGreen', 'a', 1, 0, 1234, now() )
                ...
                ,('nwea-rit', 'scienceProcessConcepts', 'growtMeasureYNFall', 'Growth Measure - Fall', 11, 'pmiRedGreen', 'a', 1, 0, 1234, now() )
                ...
                ,('nwea-rit', 'scienceGeneralScience', 'growtMeasureYNFall', 'Growth Measure - Fall', 12, 'pmiRedGreen', 'a', 1, 0, 1234, now() )
                ...
                ,('nwea-rit', 'langSurveyWGoals', 'growtMeasureYNSpg', 'Growth Measure - Spring', 121, 'pmiRedGreen', 'a', 1, 0, 1234, now() )
                ...
                ,('nwea-rit', 'mathSurveyWGoals', 'growtMeasureYNSpg', 'Growth Measure - Spring', 113, 'pmiRedGreen', 'a', 1, 0, 1234, now() )
                ...
                ,('nwea-rit', 'nweaAlgebra', 'growtMeasureYNSpg', 'Growth Measure - Spring', 115, 'pmiRedGreen', 'a', 1, 0, 1234, now() )
                ...
                ,('nwea-rit', 'primaryMath', 'growtMeasureYNSpg', 'Growth Measure - Spring', 120, 'pmiRedGreen', 'a', 1, 0, 1234, now() )
                ...
                ,('nwea-rit', 'primaryReading', 'growtMeasureYNSpg', 'Growth Measure - Spring', 119, 'pmiRedGreen', 'a', 1, 0, 1234, now() )
                ...
                ,('nwea-rit', 'readingSurveyWGoals', 'growtMeasureYNSpg', 'Growth Measure - Spring', 115, 'pmiRedGreen', 'a', 1, 0, 1234, now() )
                ...
                ,('nwea-rit', 'scienceProcessConcepts', 'growtMeasureYNSpg', 'Growth Measure - Spring', 2, NULL, 'a', 1, 0, 1234, now() )
                ...
                ,('nwea-rit', 'scienceGeneralScience', 'growtMeasureYNSpg', 'Growth Measure - Spring', 112, 'pmiRedGreen', 'a', 1, 0, 1234, now() )
        ;
