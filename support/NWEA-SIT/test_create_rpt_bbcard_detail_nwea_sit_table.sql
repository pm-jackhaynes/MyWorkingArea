/*
     ...
     NOTE: The rpt_bbcard_detail_nwea does not need to be created in the wy_sub1 (sublette) database since 
     it was already defined. This create script  will be used where it is not currently defined.
...
drop table if exists `rpt_bbcard_detail_nwea`  //


CREATE TABLE `rpt_bbcard_detail_nwea` (
  ...
  KEY `ind_rpt_bbcard_detail_nwea_stu` (`student_id`)
...
UNION=(`rpt_bbcard_detail_access`,
       `rpt_bbcard_detail_assessment`,
       `rpt_bbcard_detail_college_prep`,
       `rpt_bbcard_detail_ga_writing`,
       `rpt_bbcard_detail_grades`,
       `rpt_bbcard_detail_iri`,
       `rpt_bbcard_detail_lag_lead_hst_strand`,
       `rpt_bbcard_detail_lag_lead_hst_subject`,
       `rpt_bbcard_detail_lexile`,
       `rpt_bbcard_detail_nwea`,
       `rpt_bbcard_detail_pmrn`,
       `rpt_bbcard_detail_running_record`,
       `rpt_bbcard_detail_snap`,
       `rpt_bbcard_detail_terranova`,
       `rpt_bbcard_detail_smi_quartile`)
//
