select * from pm_bbcard_color_pmrn;

select * from c_grade_level;

select count(*) from pm_bbcard_color_pmrn;

select * from pm_bbcard_color_pmrn
order by bb_group_id, bb_measure_id, bb_measure_item_id, grade_level_id, color_id;
...
/* ************************************************************************************************* 
     ...
     OFFLOAD the color data to a tab delimited text file
...
select 
            ...
            ,gl.grade_code
            ,coalesce(pmic.moniker, '')  color_name
            ,pmrn.min_score
            ,pmrn.max_score
from pm_bbcard_color_pmrn pmrn 
    join   pm_bbcard_group g
           on pmrn.bb_group_id = g.bb_group_id
    join   pm_bbcard_measure as m
           on pmrn.bb_group_id =  m.bb_group_id
           and pmrn.bb_measure_id =  m.bb_measure_id
    join   pm_bbcard_measure_item as mi
           on      pmrn.bb_group_id = mi.bb_group_id
           and     pmrn.bb_measure_id = mi.bb_measure_id
           and     pmrn.bb_measure_item_id = mi.bb_measure_item_id
    join c_grade_level gl
           on pmrn.grade_level_id =  gl.grade_level_id
    join pmi_color as pmic
           on pmic.color_id = pmrn.color_id
order by gl.grade_code, m.bb_measure_code, mi.bb_measure_item_code, grade_code, min_score;
...
select count(*) from rpt_bbcard_detail_pmrn;  

select * from rpt_bbcard_detail_pmrn
...
from rpt_bbcard_detail_pmrn rpt
...
from mn_wayzata_ods.pmi_ods_pmrn as ods
...
Select * from mn_wayzata_ods.pmi_ods_pmrn;
...
select distinct growth_measure_flag from mn_wayzata_ods.pmi_ods_pmrn;

select * from mn_wayzata_ods.f_pmi_ods_pmrn_20120112_092251 limit 100;

select max(length(c027)) from mn_wayzata_ods.f_pmi_ods_pmrn_20120112_092251;

select count(*) from  mn_wayzata_ods.f_pmi_ods_pmrn_20120112_115348;

call mn_wayzata_ods.imp_process_upload_log();
call mn_wayzata.etl_pm_bbcard_measure_select();
]
select count(*) from  mn_wayzata_ods.pmi_ods_pmrn;
...
select c001, c002, c003 from mn_wayzata_ods.f_pmi_ods_pmrn_20120112_092251 limit 3;
select c001, c002, c003 from mn_wayzata_ods.F_Pmi_Ods_pmrn_20120112_115348  limit 3;
...
select * from pmi_admin.imp_table_column where table_id = 1000130;
 ...
 -- IMPORTANT: This drops the pmi_ods_pmrn table so you might want to back up the infomration before running
call mn_wayzata_ods.imp_sync_table_def_to_admin_by_name('pmi_ods_pmrn');
call mn_wayzata_ods.imp_drop_create_pmi_ods_table_by_name('pmi_ods_pmrn');

show create table mn_wayzata_ods.pmi_ods_pmrn;
-- create table mn_wayzata_ods.pmi_ods_pmrn_jack as select * from mn_wayzata_ods.pmi_ods_pmrn;
truncate mn_wayzata_ods.pmi_ods_pmrn;

call mn_wayzata_ods.imp_process_upload_log();
call mn_wayzata.etl_pm_bbcard_measure_select();

select * from mn_wayzata_ods.pmi_ods_pmrn order by student_id limit 100;
...
/*  ****************************************************************************************************************************************************************
      ...
      Backup pmi_ods_pmrn data
      
 *  ************************************************************************************************************************************************************** */


use mn_wayzata_ods;
create table pmi_ods_pmrn_jack as select * from pmi_ods_pmrn;
select count(*) from pmi_ods_pmrn_jack;
...
/*  ****************************************************************************************************************************************************************
      ...
      Restore pmi_ods_pmrn using your backup pmi_ods_pmrn_jack table
      
 *  ************************************************************************************************************************************************************** */

truncate mn_wayzata_ods.pmi_ods_pmrn;
insert into mn_wayzata_ods.pmi_ods_pmrn (
row_num,
student_id,
student_name,
grade,
...
goal_adj_9,
goal_name_9
From  mn_wayzata_ods.pmi_ods_pmrn_jack;

/*  ****************************************************************************************************************************************************************

      Truncate pmi_ods_pmrn and load your test data
